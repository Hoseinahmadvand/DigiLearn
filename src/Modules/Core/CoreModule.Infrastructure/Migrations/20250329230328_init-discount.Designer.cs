...
namespace CoreModule.Infrastructure.Migrations
{
    ...
    [Migration("20250329230328_init-discount")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreModule.Domain.Discounts.Models.DiscountCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CoreModule.Domain.Discounts.Models.UsedDiscount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CoreModule.Domain.HelperEntities.CourseStudent", b =>
                {
                    b.HasOne("CoreModule.Domain.Courses.Models.Course", null)
                        .WithMany()
                        .HasForeignKey("CourseId")
                    ...
                    b.OwnsMany("CoreModule.Domain.Order.Models.OrderItem", "OrderItems", b1 =>
                        {
                            ...
                            b1.HasOne("CoreModule.Domain.Courses.Models.Course", null)
                                .WithMany()
                                .HasForeignKey("CourseId")
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired();
