(()=>{
    ...
    function Pe(e, t=()=>{}
        ...
        let r = {
            ...
            _x_interceptor: !0,
            initialize(n, i, o) {
                return e(this.initialValue, ()=>Mn(n, i), s=>ht(n, i, s), i, o)
            }
        };
        return t(r),
        n=>{
...
` : ""}`, t),
    ...
    function In(e, t, r) {
        ...
        ,{scope: o={}, params: s=[]}={})=>{
            ...
            if (typeof n == "function") {
                ...
                n.finished ? (De(i, n.result, a, s, r),
    ...
    function ue(e, t, r) {
        ...
        let n = {};
        return t.map(_r((o,s)=>n[o] = s)).filter(xr).map(kn(n, r)).sort(Ln).map(o=>Dn(e, o))
    }
    function vt(e) {
    ...
    var wt = "DEFAULT"
      , G = ["ignore", "ref", "data", "id", "anchor", "bind", "init", "for", "model", "modelable", "transition", "show", "if", wt, "teleport"];
    function Ln(e, t) {
    ...
    var Ps = Tt(ti + ",async,autofocus,autoplay,controls,default,defer,disabled,hidden,loop,open,required,reversed,scoped,seamless,checked,muted,multiple,selected");
    ...
    var Ue = e=>{
      ...
      , Ls = Ue(e=>e ? `on${Mt(e)}` : "")
      , Nt = (e,t)=>e !== t && (e === e || t === t);
    var Pt = new WeakMap, we = [], k, X = Symbol("iterate"), It = Symbol("Map key iterate");
    function ai(e) {
    ...
    function V(e, t, r, n, i, o) {
        ...
        if (t === "clear")
            ...
            t) {
            case "add":
                K(e) ? qe(r) && c(s.get("length")) : (c(s.get(X)),
                ie(e) && c(s.get(It)));
                break;
            case "delete":
                K(e) || (c(s.get(X)),
    ...
    function nn(e=!1, t=!1) {
        return function(n, i, o) {
            ...
            return (Ve(i) ? rn.has(i) : di(i)) || (e || M(n, "get", i),
            t) ? a : Dt(a) ? !s || !qe(i) ? a.value : a : be(a) ? e ? ln(a) : Qe(a) : a
        }
    }
    var _i = gi();
    function gi(e=!1) {
        return function(r, n, i, o) {
            ...
            return r === _(o) && (a ? Nt(i, s) && V(r, "set", n, i, s) : V(r, "add", n, i)),
            c
        }
    }
    function xi(e, t) {
        ...
        return i && r && V(e, "delete", t, void 0, n),
        i
    }
    function yi(e, t) {
        let r = Reflect.has(e, t);
        return (!Ve(t) || !rn.has(t)) && M(e, "has", t),
        r
    }
    function bi(e) {
        return M(e, "iterate", K(e) ? "length" : X),
        Reflect.ownKeys(e)
    }
    var wi = {
        get: pi,
    ...
    function Yr(e) {
        ...
        let o = n ? n.call(t, e) : void 0
          , s = t.delete(e);
        return i && V(t, "delete", e, void 0, o),
        s
    }
    function Xr() {
        let e = _(this)
          ...
          , n = e.clear();
        return t && V(e, "clear", void 0, void 0, r),
        n
    }
    function Ye(e, t) {
        return function(n, i) {
    ...
    y("data", e=>Me(e));
    y("root", e=>W(e));
    y("refs", e=>(e._x_refs_proxy || (e._x_refs_proxy = F(Di(e))),
    e._x_refs_proxy));
    function Di(e) {
        let t = []
          , r = e;
    ...
    function mn(e) {
        let t = D(()=>document.querySelector(e), ()=>Li)();
    ...
    ;
    d("ignore", hn);
    d("effect", D((e,{expression: t},{effect: r})=>{
        r(x(e, t))
    }
    ));
    function se(e, t, r, n) {
