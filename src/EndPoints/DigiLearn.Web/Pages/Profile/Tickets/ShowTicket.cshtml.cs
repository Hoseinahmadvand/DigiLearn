...
public class ShowTicketModel : BaseRazor
{
    private ITicketService _ticketService;
    private IUserFacade _userFacade;

    public ShowTicketModel(ITicketService ticketService, IUserFacade userFacade)
    {
    ...
    public async Task<IActionResult> OnPost(Guid ticketId)
    {
        ...
        return RedirectAndShowAlert(result, RedirectToPage("ShowTicket", new { ticketId }));
    }
